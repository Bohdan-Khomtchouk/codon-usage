## ----------------------------------------------------------------------------------- ##
## Program to evaluate RF models using test data
## ----------------------------------------------------------------------------------- ##
...
load(file = "models/dnatype//random_forests/rf_model.RData") #yours will be different
...
calculate.AUC <- function(myInput_test){
  ...
  colnames(test.labels) <- c("0_true", "1_true", "2_true", "0_pred_rf", "1_pred_rf", "2_pred_rf")
